const StarRating = $container => {
  ...
  $container.addEventListener('mouseover', event => {
    ...
    arr.forEach(star => arr.indexOf(star) < arr.indexOf(event.target) ? star.classList.add('hovered') : star.classList);
  });
  ...
  $container.addEventListener('mouseout', event => {
    ...
    arr.forEach(star => arr.indexOf(star) < arr.indexOf(event.target) ? star.classList.remove('hovered') : star.classList);
  });
  ...
  $container.addEventListener('click', event => {
    ...
    arr.forEach(star => arr.indexOf(star) < arr.indexOf(event.target) ? star.classList.add('selected') : star.classList);
    ...
    let change = new CustomEvent('rating-change', { detail: $container.getAttribute('rating') });
